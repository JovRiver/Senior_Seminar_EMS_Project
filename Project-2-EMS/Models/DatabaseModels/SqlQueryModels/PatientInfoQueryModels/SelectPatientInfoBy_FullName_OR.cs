...
namespace Project_2_EMS.Models.DatabaseModels {
    public class SelectPatientInfoBy_FullName_OR : IListQuery {
        ...
        public List<T> ExecuteQuery<T>(SqlConnection connection, SqlCommand command) {
            ...
            command.CommandText = "SELECT * FROM PatientInfo WHERE FirstName LIKE @firstName OR LastName LIKE @lastName;";
