...
namespace Project_2_EMS.Models.DatabaseModels {
    public class PatientInfoQuery<T> where T : PatientInfo {
        ...
        public INonQuery Insert(PatientInfo patient) {
            Command = new SqlCommand() {
        ...
        public ISelectQuery<T> SelectBy_FullName_AND(string firstName, string lastName) {
            Command = new SqlCommand() {
        ...
        public ISelectQuery<T> SelectBy_FullName_OR(string firstName, string lastName) {
            Command = new SqlCommand() {
        ...
        public INonQuery UpdateBy_Cost_PatientId(decimal cost, int patientId) {
            Command = new SqlCommand() {
